			...
			<div class="containerImg">
				<img src="<?php echo base_url() ?>item img/tembakauHeader.jpg" alt="" style="width: 100%;">
			 	<div class="contentImg text-center">
				    <h1 style="margin-top:9vw ;font-size:5vw;" class="hidden-xs hidden-md">Jenis Tembakau</h1>
				    <h1 style="margin-top:5vw ;font-size:7vw;" class="hidden-lg hidden-md">Jenis Tembakau</h1>				    
			  	</div>
			</div>	
